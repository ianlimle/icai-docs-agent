...
class ConfluenceConfig(BaseModel):
    ...
    def promptConfig(cls) -> "ConfluenceConfig":
        ...
        while True:
            ...
            space_url = ask_text("Space URL:", required_field=True) or ""
            api_token = ask_text("API Token:", password=True, required_field=True) or ""
            email = ask_text("Email:", required_field=True) or ""

            spaces.append(ConfluenceSpace(space_url=space_url, api_token=api_token, email=email))
